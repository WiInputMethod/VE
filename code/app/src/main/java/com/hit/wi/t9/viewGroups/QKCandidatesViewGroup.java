...
import com.hit.wi.t9.functions.QKEmojiUtil;
...
//      buttonList.clear();
    ...
    public void largeTheCandidate() {
        ...
        softKeyboard8.preEdit.setVisibility(View.GONE);
    ...
    public  void smallTheCandidate() {
        softKeyboard8.viewSizeUpdate.UpdateQPCandidateSize();
        if (Global.currentKeyboard == Global.KEYBOARD_QP || Global.currentKeyboard == Global.KEYBOARD_EN) {
            softKeyboard8.functionViewGroup.setVisibility(View.VISIBLE);
        } else {
            softKeyboard8.preEdit.setVisibility(View.VISIBLE);
